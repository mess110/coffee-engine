...
var BloodParticle, LoadingScene, camera, config, engine, loadingScene, rainbow,
...
LoadingScene = (function(superClass) {
  ...
  function LoadingScene() {
    ...
    this.particle2 = new BloodParticle('imgs/splatter.png');
  ...
  LoadingScene.prototype.tick = function(tpf) {
    ...
    if ((this.bear != null) && (this.shotgun != null) && this.bunnies.any()) {
      ...
      if (config.spotLightColorEffect) {
        ...
        return this.spotLight.setColor("#" + colorDest);
      } else {
        return this.spotLight.setColor("white");
      }
    }
  };

  LoadingScene.prototype.jNorthPoleError = function(data, status) {
    document.getElementById('highscore').className = 'hidden';
    console.log("jNorthPole error: " + status);
    return console.log(data);
  };

  LoadingScene.prototype.getHighScores = function() {
  ...
  LoadingScene.prototype.resetScene = function() {
    ...
    jNorthPole.createStorage({
      ...
      console.log(data);
      return loadingScene.getHighScores();
    }, this.jNorthPoleError);
  ...
  LoadingScene.prototype.spawnBunny = function(first) {
    ...
    return JsonModelManager.get().load('bunny', 'models/bunny_all.json', (function(_this) {
      return function(mesh) {
        ...
        _this.bunny = mesh;
        if (first) {
          _this.bunny.position.set(2, 0, 20);
        } else {
